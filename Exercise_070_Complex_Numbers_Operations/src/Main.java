public class Main {
    public static void main(String[] args) {
        ...
        Because no real number satisfies this equation, 'i' is called an imaginary number. For the complex number a + bi, 'a' is called the real part, and 'b'
        is called the imaginary part. To add or subtract two complex numbers, just add or subtract the corresponding real and imaginary parts. For instance,
        the sum of 5 + 3i and 4 + 2i is 9 + 5i. For another, the sum of 3 + i and –1 + 2i is 2 + 3i.

        Write a class with the name ComplexNumber. The class needs two fields (instance variables) with name real and imaginary of type double. It represents
        the Complex Number.
